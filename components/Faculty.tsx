          ...
          {faculty.map((member, index) => (
            ...
            >
              <div className="bg-gradient-to-r from-blue-600 to-teal-500 h-32 flex items-center justify-center pt-4">
                {member.image ? (
                  <div className="relative w-24 h-24 rounded-full overflow-hidden border-4 border-white shadow-sm bg-white top-6">
                    <Image 
                      src={member.image} 
                      alt={member.name}
                      fill
              ...
              <div className="p-8 pt-10 text-center">
                ...
                <div className="space-y-2 mb-4 text-sm text-gray-600 text-left bg-gray-50 p-4 rounded-lg">
                  <p><span className="font-semibold text-gray-800">Qualification:</span> {member.qualification}</p>
                  <p><span className="font-semibold text-gray-800">Experience:</span> {member.experience}</p>
                </div>
